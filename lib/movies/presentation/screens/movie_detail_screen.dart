...
class MovieDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
        create: (context) => getIt<MoviesDetailsBloc>()
      ..add(RecommendationEvent(id: id))
      ..add(DetailsEvent(id: id)),
    lazy: false,
    child:Scaffold(
              ...
              background: FadeIn(
                ...
                child: ShaderMask(
                  ...
                  child: CachedNetworkImage(
                    ...
                    imageUrl: ConstantApp.imageUrl(state.moviesDetails!.backdropPath),
                    fit: BoxFit.cover,
                  ),
                ),
              ),
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            Text(
                              (state.moviesDetails!.voteAverage / 2).toStringAsFixed(1),
                              style: const TextStyle(
                                fontSize: 16.0,
                                fontWeight: FontWeight.w500,
                                letterSpacing: 1.2,
        ...
        (context, index) {
          ...
          return FadeInUp(
            ...
            child: ClipRRect(
              ...
              child: CachedNetworkImage(
                imageUrl: ConstantApp.imageUrl(recommendation.backdropPath!),
